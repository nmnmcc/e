    ...
    Match.value(message).pipe(
      ...
      Match.when(
        ...
        (message) =>
          ({
            role: "user",
            content: Array.map(message.content, toV2TextOrFilePart),
            ...v2ProviderOptions(message),
          }) satisfies LanguageModelV2CallOptions["prompt"][number],
      ),
      Match.when(
        ...
        (message) =>
          ({
            role: "assistant",
            content: Array.map(message.content, toV2AssistantPart),
            ...v2ProviderOptions(message),
          }) satisfies LanguageModelV2CallOptions["prompt"][number],
      ),
      Match.when(
        ...
        (message) =>
          ({
            role: "tool",
            content: Array.map(message.content, toV2ToolMessagePart),
            ...v2ProviderOptions(message),
          }) satisfies LanguageModelV2CallOptions["prompt"][number],
      ),
      Match.exhaustive,
    ...
    Match.value(message).pipe(
      ...
      Match.when(
        ...
        (message) =>
          ({
            role: "user",
            content: Array.map(message.content, toV3TextOrFilePart),
            ...v3ProviderOptions(message),
          }) satisfies LanguageModelV3CallOptions["prompt"][number],
      ),
      Match.when(
        ...
        (message) =>
          ({
            role: "assistant",
            content: Array.map(message.content, toV3AssistantPart),
            ...v3ProviderOptions(message),
          }) satisfies LanguageModelV3CallOptions["prompt"][number],
      ),
      Match.when(
        ...
        (message) =>
          ({
            role: "tool",
            content: Array.map(message.content, toV3ToolMessagePart),
            ...v3ProviderOptions(message),
          }) satisfies LanguageModelV3CallOptions["prompt"][number],
      ),
      Match.exhaustive,
          ...
          Match.tag(
            ...
            (tool) =>
              ({
                ...
                inputSchema: tool.input as JSONSchema7,
...
const toInputExamples = (
  ...
  inputExamples === undefined
    ? undefined
    : Array.map(inputExamples, (example) => ({ input: example.input as JSONObject }));
...
const fromV2GenerateResult = (
  ...
  content: Array.map(result.content, fromV2Content),
  ...
  warnings: Array.map(result.warnings, fromWarning),
});

const fromV3GenerateResult = (
  result: Awaited<ReturnType<LanguageModelV3["doGenerate"]>>,
): LanguageModel.GenerateResult => ({
  content: Array.map(result.content, fromV3Content),
  ...
  Match.value(part).pipe(
    ...
    Match.when(
      ...
      (part) =>
        ({
          _tag: "StreamStart",
          warnings: Array.map(part.warnings, fromWarning),
